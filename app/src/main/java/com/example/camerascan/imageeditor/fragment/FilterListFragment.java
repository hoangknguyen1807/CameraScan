...
import com.example.camerascan.imageeditor.adapter.FilterAdapter;
import com.example.camerascan.imageeditor.filter.PhotoProcessing;
...
public class FilterListFragment extends BaseEditFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.fragment_edit_image_filter, null);
